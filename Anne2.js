...
<div class="download-container">
    ...
    <div class="series-header">
        ...
        <div class="series-info">
            <h1>Enlaces de Descarga - Anne Shirley</h1>
    ...
    <div class="tab-content active" id="season-1">
        ...
        <div class="episodes-grid">
            <div class="episode-card">
                ...
                <div class="episode-specs">
                    <div class="episode-spec">
                        ...
                        <div class="episode-spec-value">642 MB</div>
                    </div>
                    <div class="episode-spec">
                        <div class="episode-spec-label">DURACIÓN TOTAL</div>
                        <div class="episode-spec-value">~48 min
                      </div>
                    </div>
                </div>
                <a class="download-button" href="https://tpi.li/aNN3Shy1" target="_blank">
                    <span>📥</span>
                    <span>DESCARGAR</span>
                </a>
            </div>
            ...
            <div class="episode-card">
                ...
                <div class="episode-specs">
                    <div class="episode-spec">
                        <div class="episode-spec-label">PESO</div>
                        <div class="episode-spec-value">635 MB</div>
                    </div>
                    <div class="episode-spec">
                        <div class="episode-spec-label">DURACIÓN TOTAL</div>
                ...
                <a class="download-button" href="https://tpi.li/aNN3Shy3" target="_blank">
                    <span>📥</span>
                    <span>DESCARGAR</span>
                </a>
            </div>
            ...
            <div class="episode-card">
                ...
                <div class="episode-specs">
                    <div class="episode-spec">
                        <div class="episode-spec-label">PESO&nbsp;</div>
                        <div class="episode-spec-value">655 MB</div>
                    </div>
                    <div class="episode-spec">
                        <div class="episode-spec-label">DURACIÓN TOTAL</div>
                        <div class="episode-spec-value">~48 min</div>
                ...
                <a class="download-button" href="https://tpi.li/aNN3Shy5" target="_blank">
                    <span>📥</span>
                    <span>DESCARGAR</span>
                </a>
            </div>
           ...
           <div class="episode-card">
                ...
                <div class="episode-specs">
                    <div class="episode-spec">
                        <div class="episode-spec-label">PESO</div>
                        <div class="episode-spec-value">715 MB</div>
                    </div>
                    <div class="episode-spec">
                        <div class="episode-spec-label">DURACIÓN TOTAL</div>
                        <div class="episode-spec-value">~48 min</div>
                ...
                <a class="download-button" href="https://tpi.li/aNN3Shy7" target="_blank">
                    <span>📥</span>
                    <span>DESCARGAR</span>
                </a>
            </div>
            ...
            <div class="episode-card">
                ...
                <div class="episode-specs">
                    <div class="episode-spec">
                        <div class="episode-spec-label">PESO</div>
                        <div class="episode-spec-value">628 MB</div>
                    </div>
                    <div class="episode-spec">
                        <div class="episode-spec-label">DURACIÓN TOTAL</div>
                        <div class="episode-spec-value">~48 min</div>
                ...
                <a class="download-button" href="https://tpi.li/aNN3Shy9" target="_blank">
                    <span>📥</span>
                    <span>DESCARGAR</span>
                </a>
            </div>
          ...
          <div class="episode-card">
                <div class="episode-header">
                    <div class="episode-number">11-12</div>
                    <h3 class="episode-title">Episodios 11 y 12&nbsp;</h3>
                </div>
                <div class="episode-specs">
                    <div class="episode-spec">
                        <div class="episode-spec-label">PESO</div>
                        <div class="episode-spec-value">723 MB</div>
                    </div>
                    <div class="episode-spec">
                        <div class="episode-spec-label">DURACIÓN TOTAL</div>
                        <div class="episode-spec-value">~48 min</div>
                ...
                <a class="download-button" href="https://tpi.li/aNN3Shy11" target="_blank">
                    <span>📥</span>
                    <span>DESCARGAR</span>
                </a>
            </div>
          ...
          <div class="episode-card">
                ...
                <div class="episode-specs">
                    <div class="episode-spec">
                        <div class="episode-spec-label">PESO</div>
                        <div class="episode-spec-value">755 MB</div>
                    </div>
                    <div class="episode-spec">
                        <div class="episode-spec-label">DURACIÓN TOTAL</div>
                        <div class="episode-spec-value">~48 min</div>
                ...
                <a class="download-button" href="https://tpi.li/aNN3Sh1y13" target="_blank">
                    <span>📥</span>
                    <span>DESCARGAR</span>
                </a>
            </div>
      ...
      <!--    <div class="episode-card">
                <div class="episode-header">
                    ...
                    <h3 class="episode-title">Episodio 15&nbsp;</h3>
                </div>
                <div class="episode-specs">
                    <div class="episode-spec">
                        <div class="episode-spec-label">PESO</div>
                        <div class="episode-spec-value">1.09 GB</div>
                    </div>
                    <div class="episode-spec">
                        <div class="episode-spec-label">DURACIÓN TOTAL</div>
                ...
                <a class="download-button" href="https://tpi.li/Bu3nCH1C15" target="_blank">
                    <span>📥</span>
                    <span>DESCARGAR</span>
                </a>
            </div> -->
